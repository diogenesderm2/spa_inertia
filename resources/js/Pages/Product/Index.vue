    ...
    <AuthenticatedLayout>
        <template #header>
            <div class="flex items-center justify-between">
                ...
                <Link :href="route('products.create') " class="px-3 py-2.5 text-sm font-medium text-center text-white bg-blue-700 rounded-md hover:bg-blue-800 focus:ring-4 focus:ring-blue-300 focus:outline-none">+ Adicionar Produto</Link>
            </div>
                        ...
                        <tbody>
                            <tr v-for="product in products" :key="product.id"
                                ...
                                <td class="px-6 py-4 space-x-2">
                                    ...
                                    <Link :href="route('products.destroy', product.id)" class="font-medium text-red-600 hover:underline">Delete</Link>
                                </td>
                            </tr>
                        </tbody>
                    </table>
